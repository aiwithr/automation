...
১. বেসিক অপারেশন: প্রথমে ospf = 10 এবং bgp = 20 এই দুটি ভেরিয়েবল ডিফাইন করা হয়েছে। type(ospf) দিয়ে দেখানো হয়েছে যে ospf একটা integer টাইপের ভেরিয়েবল। bgp + ospf করলে 30 ফলাফল আসে।
   ```python
   >>> ospf = 10
   >>> bgp = 20
   >>> bgp + ospf
...
আইপি ঠিকানা হল নেটওয়ার্কে একটা ডিভাইসের সনাক্তকরণ নম্বর। এটি সাধারণত দুটি ধরণের হয়: IPv4 এবং IPv6।
...
MAC ঠিকানা হল একটা নেটওয়ার্ক ইন্টারফেস কার্ডের (NIC) ইউনিক সনাক্তকারী। এটি সাধারণত 48-বিটের হয় এবং হেক্সাডেসিমাল ফরম্যাটে লেখা হয়।
