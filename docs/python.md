...
#### ফ্লোট (Float)
ফ্লোট হল দশমিক সংখ্যাসহ সংরক্ষণের জন্য ব্যবহৃত হয়। উদাহরণ:
```python
response_time = 3.14
```
...
ফাংশন এবং মেথড ব্যবহার করে কোড রিইউজেবল এবং সুসংগঠিত করা যায়। উদাহরণ:
```python
...
print(result)
```
এই ফাংশনটা আইপি অ্যাড্রেস চেক করে এবং তার ধরন রিটার্ন করে।
