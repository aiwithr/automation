...
একটা যুগ ছিল যখন নেটওয়ার্ক ইঞ্জিনিয়াররা প্রোগ্রামিংকে দূরের জিনিস মনে করতো। তাদের জগৎটা ছিল আলাদা - রাউটার, সুইচ আর ফায়ারওয়াল নিয়ে। প্রোগ্রামিং? ওটা ছিল যেন অন্য গ্রহের ভাষা।
...
ব্যাপারটা নিয়ে একদম ভয় পাবেন না। নিচের কাজগুলো একটু দেখুন, নেটওয়ার্ক ইঞ্জিনিয়ারদের কাজ আরো কঠিন। এটা অনেক সহজ মনে হবে।
...
### ৪. ইন্টারফেস এবং VLAN ডাটা মিশিয়ে ডেটা স্ট্রাকচার (উদাহরণ)

ধরুন আপনি একজন নেটওয়ার্ক ইঞ্জিনিয়ার এবং আপনার সুইচ কনফিগারেশন করার দায়িত্ব পেয়েছেন। আপনার সুইচের বিভিন্ন সেটিংস এবং কনফিগারেশনগুলো একটি নির্দিষ্ট ফরম্যাটে সংরক্ষণ করতে চান যাতে সেগুলো সহজে পড়া ও বোঝা যায়। এটি করার জন্য আমরা পাইথন প্রোগ্রামিং ভাষা ব্যবহার করে একটি স্ক্রিপ্ট লিখেছি।
...
এটি সুইচের নাম প্রিন্ট করবে। যেমন:
...
এই প্রোগ্রামের মাধ্যমে আপনি সহজেই আপনার সুইচের কনফিগারেশন দেখতে পারবেন এবং কোন ইন্টারফেস কোন VLAN এ যুক্ত আছে এবং তাদের আইপি এড্রেসগুলো জানতে পারবেন। একইভাবে, আপনি আপনার VLAN গুলোর নামও জানতে পারবেন। এটি একটি সহজ পদ্ধতি যাতে আপনি আপনার নেটওয়ার্কের কনফিগারেশন গুছিয়ে রাখতে পারবেন এবং প্রয়োজনে দ্রুত চেক করতে পারবেন।
