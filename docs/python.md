...
```
ডিকশনারি প্রায়ই বিভিন্ন ডিভাইসের ডাটা যেমন আইপি অ্যাড্রেস, ইউজারনেম, পাসওয়ার্ড ইত্যাদি সংরক্ষণ করতে ব্যবহার হয়। এটাকে আরো সুন্দর করে লেখবো আমরা নিচে।
...
এভাবে আপনি নেটওয়ার্ক কনফিগারেশন সম্পর্কিত ডাটাগুলো সুন্দরভাবে প্রিন্ট করতে পারবেন `%` সিস্টেম ব্যবহার করে।
...
এই অংশে ইন্টারফেসের ডাটা প্রিন্ট করা হয়। এখানে `for` লুপ ব্যবহার করা হয়েছে যাতে `interfaces` লিস্টের প্রতিটি ইন্টারফেসের ডাটা নিয়ে প্রিন্ট করা হয়। আউটপুট হবে:
...
এই অংশে VLAN এর ডাটা প্রিন্ট করা হয়। এখানে আবারও `for` লুপ ব্যবহার করা হয়েছে যাতে `vlans` ডিকশনারির প্রতিটি আইটেম নিয়ে প্রিন্ট করা হয়। আউটপুট হবে:
