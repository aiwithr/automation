...
CLI-তে আমরা `show` কমান্ড দিয়ে ডাটা দেখি। পাইথনে `print()` ফাংশন একই কাজ করে।
...
প্রথমে ভাবুন আপনার অফিসে তিনটা ডিভাইস আছে। প্রতিটা ডিভাইসের জন্য কিছু ডাটা সংরক্ষণ করেছেন আলাদা আলাদা লিস্টে:

- `devices` লিস্টে ডিভাইসের নাম রাখা আছে
- `types` লিস্টে কোনটা রাউটার, কোনটা সুইচ সেই ডাটা আছে
...
### লেসন ৭: ডিকশনারি - একটা জিনিসের সব ডাটা একসাথে রাখা
...
এখন একই ডিভাইসের এত ডাটা আলাদা আলাদা রাখা বিরক্তিকর। তার চেয়ে সব ডাটা একসাথে রাখি:
...
### লেসন ৮: ফাংশন - নিজের কমান্ড বানানো
...
def ping_check(ip):
    ...
    return True
```
!!! tldr "বাড়তি এক্সারসাইজ অনলাইনে"
    বইয়ের পৃষ্ঠার লিমিটেশন থাকাতে এই চ্যাপ্টারের এক্সটেন্ডেড প্র্যাকটিস ভার্সন অনলাইনে পাবেন। লিংক: https://aiwithr.github.io/automation/python1/ 
