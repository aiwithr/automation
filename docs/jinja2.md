...
নেটওয়ার্ক কনফিগারেশনের ক্ষেত্রে আমরা ছোট ছোট টেমপ্লেট তৈরি করতে পারি, যেমন ইন্টারফেস কনফিগারেশন, BGP কনফিগারেশন বা OSPF কনফিগারেশন। এরপর এই টেমপ্লেটগুলো কম্বাইন করে একটা পূর্ণ কনফিগারেশন ফাইল তৈরি করা যায়, যা একটা মাস্টার টেমপ্লেট হবে। এর কাজ হল সব জায়গা থেকে ডাটা পুল করে এনে ফাইনাল কনফিগারেশন তৈরি করা।
...
Jinja2 টেমপ্লেটিং ইঞ্জিন এবং YAML ডাটা ফাইলের মাধ্যমে কনফিগারেশন জেনারেশন করা খুবই কার্যকর একটা পদ্ধতি। এই বইয়ে আমরা Jinja2 টেমপ্লেটিং ইঞ্জিনের মাধ্যমে কিভাবে ডাইনামিক নেটওয়ার্ক কনফিগারেশন তৈরি করা যায় তা বিশদভাবে আলোচনা করব।

### YAML ডাটা ফাইল

প্রথমেই আমাদের একটা YAML ডাটা ফাইল তৈরি করতে হবে যেখানে নেটওয়ার্কের ইন্টারফেসের তথ্য থাকবে। নিচের উদাহরণে, আমরা তিনটি ইন্টারফেসের ডাটা সংরক্ষণ করেছি:
