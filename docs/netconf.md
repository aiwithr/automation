...
এই NETCONF উদাহরণটি বাংলায় ব্যাপারটা বুঝতে চাই করছি। এই কোডটি NETCONF (নেটওয়ার্ক কনফিগারেশন প্রোটোকল) ব্যবহার করে একটা সিসকো IOS XE যন্ত্রে একটা নতুন IP রুট যোগ করছে। আসুন, প্রতিটি অংশ বিস্তারিতভাবে দেখি:
...
এই কোডটি লাইন বাই লাইন ব্যাপারটা বুঝতে চাই করে দিচ্ছি:
