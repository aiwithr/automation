...
3. **ডিভাইসের তথ্য সংরক্ষণ**: প্রতিটি ডিভাইসের তথ্য একটা লুপের মাধ্যমে ডিকশনারিতে সংরক্ষণ করা হচ্ছে এবং তা `device_list` এ যোগ করা হচ্ছে।
...
নেটওয়ার্ক ডিভাইসের তথ্য একটা তালিকায় সংরক্ষণ করা হবে:
