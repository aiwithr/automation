...
6. **রেসপন্স চেক করা**: ডিভাইস থেকে পাওয়া ডেটা প্রিন্ট করা।
...
!!! tip "ব্যাপারটা বুঝতে চাই"
    মনে করুন, আপনি CLI-তে `show hostname` কমান্ড দিচ্ছেন। কিন্তু এখানে সেটা করছেন API দিয়ে। এতে করে আপনি প্রোগ্রামাটিক্যালি ডিভাইসের ডাটা পেতে পারছেন।
